...
extern volatile bool ezTime_debug  ;       // to debug ezTime operation
extern volatile bool gps_debug  ;          // to debug gps operation
extern volatile bool ezTime_debug  ;       // to debug ezTime operation
extern volatile unsigned long  GPS_rising_pps_millis ;
extern volatile time_t NTP_sync_time ;           // patched ezTime to support NTP sync 
...
extern volatile float ppm_runtime ;    // global data for average ppm deviation
...
#define NTP_LOCAL_PORT			4545
//#define NTP_SERVER				"pool.ntp.org"
#define NTP_SERVER        "0.it.pool.ntp.org"

#define NTP_TIMEOUT				1500			// milliseconds 1500 in origine 
#define NTP_INTERVAL			1801				// default update interval in seconds 1801 in origine
#define NTP_RETRY				20				// Retry after this many seconds on failed NTP
#define NTP_STALE_AFTER			100				// If update due for this many seconds, set timeStatus to timeNeedsSync 3602 originale
...
// GPS related variables & prototypes
bool queryGPS(time_t &GPS_t,  unsigned long  &GPS_measured_at ) ;
void ezTime_setup();
...
//******************************
#define GPS_RETRY       20        // Retry after this many seconds on failed GPS
#define GPS_STALE_AFTER 360
#define GPS_INTERVAL    180
...
//		void setNTPInterval(const uint16_t seconds = 61);
//		void setGPSInterval(const uint16_t seconds = 61);
