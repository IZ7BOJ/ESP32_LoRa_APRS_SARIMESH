...
struct Config
{
  ...
  float LoraFreq;       // lora frequency, e.g. 433.725
  float LoraBw;         // lora bandwidth, e.g. 125
  ...
  String AprsRawBeacon; // aprs string for server beacon, e.g. NOCALL-1>APZMDM,WIDE1-1:!0000.00N/00000.00E#LoRA 433.725MHz/BW125/SF12/CR7/0xf3
  int AprsRawBeaconPeriodSeconds; // aprs beacon period
