...
void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>Save/Restore Configuration</title>"); // NOTE: 1em = 16px
  ...
  webpage += F("</style></head><body><h1>Save/Restore Configuration"); 
...
//  webpage += F("<ul>");
//  webpage += F("<li><a href='/admin.html'>Home</a></li>"); // Lower Menu bar command entries
